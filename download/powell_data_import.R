# this file is from Mike. I haven't gotten it to work yet
...
setwd('C:/Users/Alice Carter/git/loticlentic_synthesis/data/powell_data_import')
cur_time = Sys.time()
...
sb_usr = 'alicecarter05@gmail.com'
sb_pass = 'Hqud2BbQhNQ!h9w'
