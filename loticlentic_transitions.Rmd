...
Looking at the medians across all sites, we see that most sites span the range between lake like (slow turnover, low turbulence) to stream like (fast turnover, high turbulence). There does not appear to be a strong relationship between median oxygen depletion and lotic/lentic behavior across sites.
